public class EquilateralTriangle extends Triangle {
    ...
    public EquilateralTriangle(int point1X, int point1Y, int point2X, int point2Y, int point3X, int point3Y) throws Exception {
        ...
        if ((sideA == sideB) && (sideA != sideC) || (sideA == sideC) && (sideA != sideB)) {
            throw new Exception("Not Equilateral triangle");
        }
    }
